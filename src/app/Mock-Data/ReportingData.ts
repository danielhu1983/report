...
export  class ReportingData{
    ...
    public static getcarJson(): any{
        let rect: rep8.RECT = new rep8.RECT();
        rect.right = 186;
        rect.bottom = 332;
        let result: rep8.ReportDialog = JSON.parse(this.getCar());
